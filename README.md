...
* **Turistei**
  Marketplace backend with multi-provider architecture, financial rules per item, authentication and scalable structure
...
* **Turistei**
  Backend de marketplace com arquitetura multi-fornecedor, regras financeiras por item, autenticação e estrutura escalável
  🔗 https://github.com/44CodeSimone/turistei
